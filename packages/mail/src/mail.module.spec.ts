  ...
  it('registers sync providers and exports', () => {
    ...
    expect(providers).toEqual(
      expect.arrayContaining([
        expect.objectContaining({ provide: CONFIG_OPTIONS, useValue: options }),
    ...
    expect(dynamicModule.exports).toEqual(
      expect.arrayContaining([MailService, CONFIG_OPTIONS, MAIL_STRATEGY.smtp, MAIL_STRATEGY.ses, MAIL_STRATEGY.mailgun]),
    )
  })
